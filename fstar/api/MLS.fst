...
let process_welcome_message w (sign_pk, sign_sk) lookup =
  ...
  let? (treekem_state, encryption_secret) = MLS.TreeKEM.API.welcome treekem leaf_decryption_key opt_path_secret_and_inviter_ind leaf_index secrets.joiner_secret [] group_context in
