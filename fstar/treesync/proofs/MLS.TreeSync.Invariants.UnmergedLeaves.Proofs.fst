...
val leaf_at_tree_add:
  ...
  (ensures leaf_at (Success?.v (tree_add t li content)) li' == (if li = li' then Some content else leaf_at t li'))
...
val unmerged_leaf_consistent_tree_add_self:
  ...
  Lemma
  (requires Success? (tree_add t li content))
  (ensures unmerged_leaf_consistent (Success?.v (tree_add t li content)) li)
...
val unmerged_leaf_consistent_tree_add_other:
  ...
  Lemma
  (requires Success? (tree_add t li content) /\ unmerged_leaf_consistent t li')
  (ensures unmerged_leaf_consistent (Success?.v (tree_add t li content)) li')
...
val unmerged_leaves_ok_tree_add:
  ...
  Lemma
  (requires Success? (tree_add t li content) /\ unmerged_leaves_ok t)
  (ensures unmerged_leaves_ok (Success?.v (tree_add t li content)))
let rec unmerged_leaves_ok_tree_add #bytes #bl #tkt #l #i t li content =
  ...
  | TNode opt_content left right -> (
    ...
    | None -> ()
    | Some cont -> (
      let Success new_tree = tree_add t li content in
      ...
      list_for_all_eq (unmerged_leaf_consistent new_tree) (insert_sorted li cont.unmerged_leaves);
      list_for_all_eq (unmerged_leaf_exists t) cont.unmerged_leaves;
      list_for_all_eq (unmerged_leaf_exists new_tree) (insert_sorted li cont.unmerged_leaves);
      ...
      introduce forall x. List.Tot.mem x (insert_sorted li cont.unmerged_leaves) ==> Some? (leaf_at new_tree x)
      with (
...
val unmerged_leaves_ok_apply_path_aux:
  ...
  (ensures unmerged_leaves_ok (Success?.v (apply_path_aux t p parent_parent_hash)))
...
val unmerged_leaves_ok_apply_path:
  ...
  (ensures unmerged_leaves_ok (Success?.v (apply_path t p)))
