...
val intro_all_credentials_ok: #bytes:Type0 -> {|bytes_like bytes|} -> #tkt:treekem_types bytes -> #asp:as_parameters bytes -> #l:nat -> #i:tree_index l -> ts:treesync bytes tkt l i -> ast:as_tokens bytes asp l i -> (li:leaf_index l i -> squash (one_credential_ok ts ast li)) -> squash (all_credentials_ok ts ast)
...
val all_credentials_ok_tree_add: #bytes:Type0 -> {|bytes_like bytes|} -> #tkt:treekem_types bytes -> #asp:as_parameters bytes -> #l:nat -> #i:tree_index l -> ts:treesync bytes tkt l i -> ast:as_tokens bytes asp l i -> li:leaf_index l i -> ln:leaf_node_nt bytes tkt -> token:asp.token_t -> Lemma
  (requires
...
val all_credentials_ok_tree_update: #bytes:Type0 -> {|bytes_like bytes|} -> #tkt:treekem_types bytes -> #asp:as_parameters bytes -> #l:nat -> #i:tree_index l -> ts:treesync bytes tkt l i -> ast:as_tokens bytes asp l i -> li:leaf_index l i -> ln:leaf_node_nt bytes tkt -> token:asp.token_t -> Lemma
  (requires
    asp.credential_ok (ln.data.signature_key, ln.data.credential) token /\
    all_credentials_ok ts ast
  )
...
val all_credentials_ok_tree_remove: #bytes:Type0 -> {|bytes_like bytes|} -> #tkt:treekem_types bytes -> #asp:as_parameters bytes -> #l:nat -> #i:tree_index l -> ts:treesync bytes tkt l i -> ast:as_tokens bytes asp l i -> li:leaf_index l i -> Lemma
...
val all_credentials_ok_apply_path: #bytes:Type0 -> {|crypto_bytes bytes|} -> #tkt:treekem_types bytes -> #asp:as_parameters bytes -> #l:nat -> #li:leaf_index l 0 -> ts:treesync bytes tkt l 0 -> ast:as_tokens bytes asp l 0 -> p:pathsync bytes tkt l 0 li -> token:asp.token_t -> Lemma
  (requires
...
val all_credentials_ok_left_right: #bytes:Type0 -> {|bytes_like bytes|} -> #tkt:treekem_types bytes -> #asp:as_parameters bytes -> #l:pos -> #i:tree_index l -> ts:treesync bytes tkt l i -> ast:as_tokens bytes asp l i -> Lemma
  (requires all_credentials_ok ts ast)
  (ensures (
...
val all_credentials_ok_tree_truncate: #bytes:Type0 -> {|bytes_like bytes|} -> #tkt:treekem_types bytes -> #asp:as_parameters bytes -> #l:pos -> ts:treesync bytes tkt l 0 -> ast:as_tokens bytes asp l 0 -> Lemma
...
val all_credentials_ok_tree_extend: #bytes:Type0 -> {|bytes_like bytes|} -> #tkt:treekem_types bytes -> #asp:as_parameters bytes -> #l:nat -> ts:treesync bytes tkt l 0 -> ast:as_tokens bytes asp l 0 -> Lemma
  (requires all_credentials_ok ts ast)
...
val all_credentials_ok_weaken: #bytes:Type0 -> {|bytes_like bytes|} -> #tkt:treekem_types bytes -> #asp_strong:as_parameters bytes -> #l:nat -> #i:tree_index l -> asp_weak:as_parameters bytes -> ts:treesync bytes tkt l i -> ast:as_tokens bytes asp_strong l i -> Pure (as_tokens bytes asp_weak l i)
