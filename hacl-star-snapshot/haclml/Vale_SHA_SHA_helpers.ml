         ...
         fun blocks ->
           Obj.magic
             (update_multi_opaque_aux Spec_Hash_Definitions.SHA2_256
                (Obj.magic hash) (Obj.repr ()) blocks)) uu___1 uu___
...
let (make_hash_def :
  Vale_Def_Types_s.quad32 ->
    Vale_Def_Types_s.quad32 -> (FStar_UInt32.t, unit) Lib_Sequence.lseq)
  =
  fun abef ->
    fun cdgh ->
      ...
      let hash = FStar_Seq_Base.seq_of_list l in hash
let (make_hash :
      ...
      then to_uint32 (ws_opaque b t)
        ...
        (let t16 = to_uint32 (ws_opaque b (t - (Prims.of_int (16)))) in
         ...
         let s1 =
           FStar_UInt32.logxor
             (FStar_UInt32.logor
                (FStar_UInt32.shift_right t2 (Stdint.Uint32.of_int (17)))
                (FStar_UInt32.shift_left t2
                   (FStar_UInt32.uint_to_t (Prims.of_int (15)))))
             (FStar_UInt32.logxor
                (FStar_UInt32.logor
                   (FStar_UInt32.shift_right t2 (Stdint.Uint32.of_int (19)))
                   (FStar_UInt32.shift_left t2
                      (FStar_UInt32.uint_to_t (Prims.of_int (13)))))
                (FStar_UInt32.shift_right t2 (Stdint.Uint32.of_int (10)))) in
         let s0 =
           FStar_UInt32.logxor
             (FStar_UInt32.logor
                (FStar_UInt32.shift_right t15 (Stdint.Uint32.of_int (7)))
                (FStar_UInt32.shift_left t15
                   (FStar_UInt32.uint_to_t (Prims.of_int (25)))))
             (FStar_UInt32.logxor
                (FStar_UInt32.logor
                   (FStar_UInt32.shift_right t15 (Stdint.Uint32.of_int (18)))
                   (FStar_UInt32.shift_left t15
                      (FStar_UInt32.uint_to_t (Prims.of_int (14)))))
                (FStar_UInt32.shift_right t15 (Stdint.Uint32.of_int (3)))) in
