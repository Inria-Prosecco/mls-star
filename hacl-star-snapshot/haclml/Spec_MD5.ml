...
let (init : unit Spec_Hash_Definitions.init_t) =
  Obj.magic
...
let (round2_aux : abcd_t -> x_t -> abcd_t) =
  fun abcd ->
    fun x ->
      let abcd1 =
        round2_op abcd x ia ib ic id Prims.int_one (Stdint.Uint32.of_int (5))
          (Prims.of_int (17)) in
      let abcd2 =
        round2_op abcd1 x id ia ib ic (Prims.of_int (6))
          (Stdint.Uint32.of_int (9)) (Prims.of_int (18)) in
      let abcd3 =
        round2_op abcd2 x ic id ia ib (Prims.of_int (11))
          (Stdint.Uint32.of_int (14)) (Prims.of_int (19)) in
      let abcd4 =
        round2_op abcd3 x ib ic id ia Prims.int_zero
          (Stdint.Uint32.of_int (20)) (Prims.of_int (20)) in
      let abcd5 =
        round2_op abcd4 x ia ib ic id (Prims.of_int (5))
          (Stdint.Uint32.of_int (5)) (Prims.of_int (21)) in
      let abcd6 =
        round2_op abcd5 x id ia ib ic (Prims.of_int (10))
          (Stdint.Uint32.of_int (9)) (Prims.of_int (22)) in
      let abcd7 =
        round2_op abcd6 x ic id ia ib (Prims.of_int (15))
          (Stdint.Uint32.of_int (14)) (Prims.of_int (23)) in
      let abcd8 =
        round2_op abcd7 x ib ic id ia (Prims.of_int (4))
          (Stdint.Uint32.of_int (20)) (Prims.of_int (24)) in
      let abcd9 =
        round2_op abcd8 x ia ib ic id (Prims.of_int (9))
          (Stdint.Uint32.of_int (5)) (Prims.of_int (25)) in
      let abcd10 =
        round2_op abcd9 x id ia ib ic (Prims.of_int (14))
          (Stdint.Uint32.of_int (9)) (Prims.of_int (26)) in
      let abcd11 =
        round2_op abcd10 x ic id ia ib (Prims.of_int (3))
          (Stdint.Uint32.of_int (14)) (Prims.of_int (27)) in
      let abcd12 =
        round2_op abcd11 x ib ic id ia (Prims.of_int (8))
          (Stdint.Uint32.of_int (20)) (Prims.of_int (28)) in
      let abcd13 =
        round2_op abcd12 x ia ib ic id (Prims.of_int (13))
          (Stdint.Uint32.of_int (5)) (Prims.of_int (29)) in
      let abcd14 =
        round2_op abcd13 x id ia ib ic (Prims.of_int (2))
          (Stdint.Uint32.of_int (9)) (Prims.of_int (30)) in
      let abcd15 =
        round2_op abcd14 x ic id ia ib (Prims.of_int (7))
          (Stdint.Uint32.of_int (14)) (Prims.of_int (31)) in
      let abcd16 =
        round2_op abcd15 x ib ic id ia (Prims.of_int (12))
          (Stdint.Uint32.of_int (20)) (Prims.of_int (32)) in
      abcd16
...
let (update_aux :
  ...
  fun abcd ->
    fun x ->
      let x1 =
        Obj.magic
          (Spec_Hash_Definitions.words_of_bytes Spec_Hash_Definitions.MD5
             (Prims.of_int (16)) x) in
      let aa = FStar_Seq_Base.index abcd ia in
      let bb = FStar_Seq_Base.index abcd ib in
      let cc = FStar_Seq_Base.index abcd ic in
      let dd = FStar_Seq_Base.index abcd id in
      let abcd1 = rounds abcd x1 in
      overwrite abcd1
        (FStar_UInt32.add_mod (FStar_Seq_Base.index abcd1 ia) aa)
        (FStar_UInt32.add_mod (FStar_Seq_Base.index abcd1 ib) bb)
        (FStar_UInt32.add_mod (FStar_Seq_Base.index abcd1 ic) cc)
        (FStar_UInt32.add_mod (FStar_Seq_Base.index abcd1 id) dd)
let (update : unit Spec_Hash_Definitions.update_t) = Obj.magic update_aux